...
<?php 
if(!empty($_POST["ss"][0])){
    $sql ="select * from tick order by tick_cnt desc limit 1";
    ...
    $non = date("Ymd")."000".$rrr;
    for($i=0;$i<count($_POST["ss"]);$i++){
        $sql ="insert into tick value(NULL,'$non','".$_POST["movie"]."','".$_POST["date"]."','".$_POST["site"]."','".$_POST["ss"][$i]."','$rrr')";
